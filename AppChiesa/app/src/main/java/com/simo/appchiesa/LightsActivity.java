...
public class LightsActivity extends Activity {
    ...
    public static Context lightsContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Context context = Home.homeContext;
        ...
        lightsContext = getApplicationContext();

        lightCircuits = new LightCircuits();
        arduino = new ArduinoConnection(lightsContext);

        // carico gli stati delle luci
        arrayLights = lightCircuits.loadLights(lightsContext);

        // Carico le immagini degli ImageButtons
        ibCH4.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(0), ibCH4.getContext()));
        ibCH5.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(1), ibCH5.getContext()));
        ibCH6a.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(2), ibCH6a.getContext()));
        ibCH6b.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(3), ibCH6b.getContext()));
        ibCH7.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(4), ibCH7.getContext()));
        ibCH8.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(5), ibCH8.getContext()));
        ibCH9.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(6), ibCH9.getContext()));
        ibCH10.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(7), ibCH10.getContext()));
        ibCH11.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(8), ibCH11.getContext()));
        ibCH12a.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(9), ibCH12a.getContext()));
        ibCH12b.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(10), ibCH12b.getContext()));
        ibCH13.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(11), ibCH13.getContext()));
        ibCH14.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(12), ibCH14.getContext()));
        ibCH15.setImageBitmap(LightCircuits.setImageLights(arrayLights.get(13), ibCH15.getContext()));

        // Gestione pressione dei bottoni
        ibCH4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (arrayLights.get(0).equals("off")) {
                    ibCH4.setImageBitmap(LightCircuits.setImageLights("on", ibCH4.getContext()));
                    arrayLights.set(0, "on");
                ...
                lightCircuits.saveLights(arrayLights, lightsContext);
            }
        });
        ...
        ibReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent();
                i.setClass(LightsActivity.this, Home.class);
                startActivity(i);
                finish();
            }
        });
